...
import { Client, Commande, ligneCommande, Produit } from "@prisma/client";
...
export default function ModifierCommandeForm(commande: Commande) {
  ...
  const form = useForm<z.infer<typeof formSchema>>({
    ...
    defaultValues: {
      codeCommande: commandeData.code,
      dateCommande: commandeData?.dateCommande,
      clientId: commandeData?.clientId.toString(),
      status: commandeData?.status,
      dateLivraison: commandeData?.livraison?.dateLivraison,
      statusLivraison: commandeData?.livraison?.status,
    },
  });
